...
// of arr to be sorted */
void mergeSort(int array[], int const begin, int const end) // NOLINT(Misc-no-recursion)
{
    if (begin >= end)
...
int main()
{
    ...
    cout << "Given array is \n";
    printArray(arr, static_cast<int>(arr_size));

    mergeSort(arr, 0, static_cast<int>(arr_size - 1));
